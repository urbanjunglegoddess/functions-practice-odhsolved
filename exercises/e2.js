...
// Your code goes here:
let room1 = rectArea(4, 6), room2 = rectArea(13, 3), room3 = rectArea(4, 8);
console.log (`The area of room1 is ${room1}`);
console.log (`The area of room2 is ${room2}`);
console.log (`The area of room3 is ${room3}`);
